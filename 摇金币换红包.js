  ...
  return {
    ...
    actionLoop: [
      ...
      /**"恭喜你，摇到奖励啦"标签 */
      {
        name: '"恭喜你，摇到奖励啦"标签',
        if: function () {
          return className("android.view.View").text("恭喜你，摇到奖励啦").exists()
        },
        run: function () {
          // 按钮无法定位，希望它是你永远的唯一
      ...
      /**"摇红包"按钮 */
      {
        name: '"摇红包"按钮',
        if: function () {
          return className("android.widget.Image").text("摇红包").exists() && className("android.view.View").text("可兑换金币").exists()
        },
        run: function () {
    ...
    actionEndIf: [{
      name: '今天摇太多次了',
      if: function () {
        return className("android.view.View").text("今天摇太多次了").exists();
      }
    }, {
  ...
  this.actionRun = function () {
    ...
    while (isLoop()) {
      ...
      if (typeof curRun === 'function') {
        ...
        console.log('curRun: ' + typeof curRun)
      }
    }
